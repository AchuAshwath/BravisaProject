...
class BTTIndex():
    ...
    def calc_btt_divisor(self, conn, date):
        ...
        if btt_prevData.empty == True:
                
            default_val = 1000
            btt_prevData['OPEN'] = default_val
            btt_prevData['HIGH'] = default_val
            btt_prevData['LOW'] = default_val
            btt_prevData['CLOSE'] = default_val
            
        # merge_btt_divisor = btt_prevData
        ...
        os_current = os_current_list.item() 
        ...
        if(os_prev == os_current):
            ...
            divisor_current = ff_close_current/prev_close
